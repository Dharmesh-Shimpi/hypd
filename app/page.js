...
const ScrollComponent = () => {
  ...
  return (
    <div className="flex bg-black relative z-10">
      ...
      <div className="sticky top-24 right-16 w-2/3 h-screen flex justify-center items-center overflow-hidden">
        <div
...
const ParallaxComponent = () => (
  <div className="fixed top-40 left-0 w-full h-screen overflow-hidden z-0">
    <Image
